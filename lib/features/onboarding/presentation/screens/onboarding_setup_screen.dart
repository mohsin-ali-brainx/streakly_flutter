  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            const OnboardingProgressHeader(step: OnboardingProgress.setupStep),
                  ...
                  Consumer<OnboardingSetupController>(
                    builder: (context, c, _) {
                      return GridView.builder(
                        ...
                        itemCount:
                            kStarterTemplates.length + c.customTemplates.length + 1,
                        itemBuilder: (context, index) {
                          ...
                          if (index == addButtonIndex) {
                            return InkWell(
                              ...
                              onTap: () =>
                                  _showAddCustomHabitDialog(context, c),
                              child: Ink(
...
class _AddCustomHabitDialogResult {
  const _AddCustomHabitDialogResult({
    required this.title,
    this.subtitle,
  });
